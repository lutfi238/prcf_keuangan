...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2025 at 04:43 PM
...
(2, 2, '', '0000-00-00', 'Travel to Nangah Jemah', 'Lutfi Travel', '20208-PR-01', '20208', 1, 1500000.00, 0.00, 0.00, 0.00, '', '../../uploads/receipts/1761548496_1_Screenshot_2025-10-27_121457.png', '2025-10-27 07:01:36', '2025-10-27 07:01:36'),
(3, 3, 'INV-20251027-001', '2025-10-27', 'testing item hapus nama proposal otomatis', 'lutfi', 'TMP-001', 'EXP-123', 1, 1000000.00, 1000000.00, 950000.00, 50000.00, 'Pembelian alat uji coba sistem proposal otomatis', '../../uploads/receipts/1761553233_1_Screenshot_2025-10-25_181139.png', '2025-10-27 08:20:33', '2025-10-27 08:20:33'),
(4, 4, 'INV-PNK-1025-001', '2025-10-28', 'Pembelian Kertas A4 1 Rim (80gsm) untuk kebutuhan administrasi', 'Aam', 'PNK-OFF', 'ATK-001', 1, 58000.00, 58000.00, 58000.00, 0.00, 'Digunakan untuk aktivitas administrasi harian', '../../uploads/receipts/1761663078_1_RobloxScreenShot20251020_225818585.png', '2025-10-28 14:51:18', '2025-10-28 14:51:18');
...
(2, 'PRJ-2025-001', 'Fire training Nangah Jemah Village', 'Perjalanan', 'Chandra', '2025-10-27', '2025-10-29', 'IDR', 16115.0000, 1, 8, 4, 'approved', '', '2025-10-27 07:01:36', '2025-10-27 07:12:49'),
(3, 'PRJ-2025-001', 'Tes - Akun ke-2.2', 'testing kegiatan hapus nama proposal otomatis', 'Chandra', '2025-10-27', '2025-10-27', 'IDR', 1.0000, 1, NULL, NULL, '', 'testing revisi', '2025-10-27 08:20:33', '2025-10-27 10:10:27'),
(4, 'PRJ-2025-001', 'TEST - Proposal untuk DIR Approval', 'Pengadaan Peralatan Kantor untuk Kantor Pontianak', 'Chandra', '2025-10-28', '2025-10-28', 'IDR', 1.0000, 1, NULL, NULL, '', 'budget kurangin', '2025-10-28 14:51:18', '2025-10-28 14:59:08');
...
INSERT INTO `notifications` (`id`, `user_id`, `title`, `message`, `type`, `related_id`, `is_read`, `created_at`, `read_at`) VALUES
(1, 1, 'Pengadaan Peralatan Kantor untuk Kantor Pontianak', 'Laporan keuangan Anda untuk kegiatan \"Pengadaan Peralatan Kantor untuk Kantor Pontianak\" memerlukan revisi.', 'revision_request', 4, 0, '2025-10-28 21:59:11', NULL);
...
(14, 'Fire training Nangah Jemah Village', 'Lutfi', '2025-10-27', 'Chandra', 'approved', 4, 9, '2025-10-27 13:33:49', '2025-10-27 13:35:52', 'PRJ-2025-001', '../../uploads/tor/1761546758_KWU5_5E_3202316041_MUHAMMAD LUTFI FIRDAUS.pdf', '../../uploads/budgets/1761546758_KWU5_5E_3202316041_MUHAMMAD LUTFI FIRDAUS.pdf', '2025-10-27 06:32:38', '2025-10-27 06:35:52'),
(15, 'Test', 'lutfi', '2025-10-27', 'Chandra', 'rejected', NULL, NULL, NULL, NULL, 'PRJ-2025-001', '../../uploads/tor/1761547027_KWU5_5E_3202316041_MUHAMMAD LUTFI FIRDAUS.pdf', '../../uploads/budgets/1761547027_KWU5_5E_3202316041_MUHAMMAD LUTFI FIRDAUS.pdf', '2025-10-27 06:37:07', '2025-10-27 06:37:31');
...
(8, 'Ferrosi', 'Staff Accountant', 'ferrosipratamaqu@gmail.com', '6282134812641', '$2y$10$c.kiil8chyMEiAqZgzpR7u5sqVVftQIJJLyKIckfatqprVRXNLuqO', '2025-10-19 13:22:11', '2025-10-27 06:17:28'),
(9, 'lutfi', 'Direktur', 'lutfifirdaus238@gmail.com', '6285752706608', '$2y$10$2fH773o5wxutvRZtlEKm2O/PNR6riXAOfdta1jT26dKhKyJnDFqnS', '2025-10-20 01:02:46', '2025-10-27 06:16:59');
...
--
ALTER TABLE `laporan_keuangan_detail`
  MODIFY `id_detail_keu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `laporan_keuangan_header`
--
ALTER TABLE `laporan_keuangan_header`
  MODIFY `id_laporan_keu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `fk_notifications_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
