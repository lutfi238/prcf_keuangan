...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    die('Error: No bank header ID specified');
}

$id_bank_header = $_GET['id'];
...
if ($header_result->num_rows === 0) {
    die('Error: Bank header not found');
}

$header = $header_result->fetch_assoc();

// Fetch detail transactions
$details_query = "SELECT * FROM buku_bank_detail 
    WHERE id_bank_header = ? 
    ORDER BY tanggal ASC, id_detail_bank ASC";

$details_stmt = $conn->prepare($details_query);
$details_stmt->bind_param("s", $id_bank_header);
...
// Determine primary currency for the report
$primary_currency = $header['currency'];

// ============================================================
// INTELLIGENT ORIENTATION DETECTION
// ============================================================
// Calculate total content width to determine optimal orientation
// Bank Book has 10 columns with varying widths
...
$total_width = array_sum($column_widths); // 1130 units
...
if ($max_title_length > 30) {
    $column_widths[2] = 250; // Increase Title Activity width
}
if ($max_description_length > 25) {
    $column_widths[3] = 180; // Increase Cost Description width
}
if ($max_recipient_length > 15) {
    $column_widths[4] = 120; // Increase Recipient width
}
...
if ($adjusted_total_width <= $portrait_threshold) {
    ...
    $column_widths[2] = min($column_widths[2], 280); // Title Activity max
    $column_widths[3] = min($column_widths[3], 200); // Cost Description max
}
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Bank Book">
  ...
  <Table>
   ...
   <Column ss:Width="<?php echo $column_widths[9]; ?>"/>
   
   <!-- Title Row -->
   <Row ss:Height="25">
    <Cell ss:MergeAcross="9" ss:StyleID="s62">
     <Data ss:Type="String">BANK BOOK - <?php echo strtoupper($primary_currency); ?></Data>
    </Cell>
   </Row>
   ...
   <Row ss:Height="18">
    ...
    <Cell ss:MergeAcross="2" ss:StyleID="s70">
     <Data ss:Type="String"><?php echo htmlspecialchars($header['bank_name']); ?></Data>
    </Cell>
   </Row>
   <Row ss:Height="18">
    <Cell ss:StyleID="s69"><Data ss:Type="String">Account Name:</Data></Cell>
    <Cell ss:MergeAcross="2" ss:StyleID="s70">
     <Data ss:Type="String"><?php echo htmlspecialchars($header['account_name']); ?></Data>
    </Cell>
   </Row>
   <Row ss:Height="18">
    <Cell ss:StyleID="s69"><Data ss:Type="String">Account Number:</Data></Cell>
    <Cell ss:MergeAcross="2" ss:StyleID="s70">
     <Data ss:Type="String"><?php echo htmlspecialchars($header['account_number']); ?></Data>
    </Cell>
   </Row>
   <Row ss:Height="18">
   ...
   <Row ss:Height="20">
    ...
    <Cell ss:StyleID="s66"><Data ss:Type="Number">0</Data></Cell>
    <Cell ss:StyleID="s66"><Data ss:Type="Number"><?php echo $header['saldo_awal_idr']; ?></Data></Cell>
    <Cell ss:StyleID="s66"><Data ss:Type="Number">0</Data></Cell>
    <Cell ss:StyleID="s66"><Data ss:Type="Number">0</Data></Cell>
   </Row>
   ...
   <Row ss:Height="20">
    <Cell ss:StyleID="s67">
     <Data ss:Type="String"><?php echo date('d/m/Y', strtotime($detail['tanggal'])); ?></Data>
    </Cell>
    <Cell ss:StyleID="s65">
     <Data ss:Type="String"><?php echo htmlspecialchars($detail['reff']); ?></Data>
    </Cell>
    <Cell ss:StyleID="s65">
     <Data ss:Type="String"><?php echo htmlspecialchars($detail['title_activity']); ?></Data>
    </Cell>
    <Cell ss:StyleID="s65">
     <Data ss:Type="String"><?php echo htmlspecialchars($detail['cost_description']); ?></Data>
    </Cell>
    <Cell ss:StyleID="s65">
   ...
   <Row ss:Height="22">
    ...
    <Cell ss:StyleID="s68"><Data ss:Type="String"></Data></Cell>
    <Cell ss:StyleID="s68">
     <Data ss:Type="Number"><?php echo $header['saldo_akhir_idr']; ?></Data>
    </Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String"></Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String"></Data></Cell>
   </Row>
   ...
   <Row ss:Height="18">
    ...
    <Cell ss:StyleID="s66">
     <Data ss:Type="Number"><?php echo $header['current_period_change_idr']; ?></Data>
    </Cell>
   </Row>
   <Row ss:Height="15"></Row>
   <Row ss:Height="18">
   ...
   <Row ss:Height="18">
    ...
    <Cell ss:StyleID="s66">
     <Data ss:Type="Number"><?php echo $header['current_period_change_usd']; ?></Data>
    </Cell>
   </Row>
   ...
   <Row ss:Height="18">
    <Cell ss:MergeAcross="2">
     <Data ss:Type="String">Prepared by: <?php echo htmlspecialchars($header['prepared_by']); ?></Data>
    </Cell>
   </Row>
   <Row ss:Height="18">
    <Cell ss:MergeAcross="2">
